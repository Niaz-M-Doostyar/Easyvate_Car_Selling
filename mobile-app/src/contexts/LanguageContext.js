...
const translations = {
  en: {
    ...
    Appearance: 'Appearance', 'Dark Mode': 'Dark Mode', 'Switch between light and dark': 'Switch between light and dark', 'Accent Color': 'Accent Color', Database: 'Database', About: 'About', 'App Name': 'App Name', Version: 'Version', Platform: 'Platform', Developer: 'Developer', 'Create Backup': 'Create Backup', 'Export database as SQL file': 'Export database as SQL file', 'Restore Database': 'Restore Database', 'Import from SQL backup file': 'Import from SQL backup file', 'Sign Out': 'Sign Out', User: 'User', Viewer: 'Viewer',
...
export function LanguageProvider({ children }) {
  ...
  const value = useMemo(() => ({
    ...
    fontFamily: language === 'en' ? (Platform.OS === 'ios' ? 'Avenir Next' : 'sans-serif') : (Platform.OS === 'ios' ? 'Geeza Pro' : 'sans-serif'),
